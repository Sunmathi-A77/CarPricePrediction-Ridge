...
# installed.
TCL_PREFIX='C:/Ridge-Car Price Prediction/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Ridge-Car Price Prediction/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Ridge-Car Price Prediction/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Ridge-Car Price Prediction/myvenv\Library\include'
...
TCL_PACKAGE_PATH='C:/Ridge-Car Price Prediction/myvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Ridge-Car Price Prediction/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Ridge-Car Price Prediction/myvenv\Library\lib\tclstub86.lib'
